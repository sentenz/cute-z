...
#ifndef NAMESPACE_UMATI_GENERATED_H_
#define NAMESPACE_UMATI_GENERATED_H_
...
extern UA_StatusCode namespace_umati_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_UMATI_GENERATED_H_ */
