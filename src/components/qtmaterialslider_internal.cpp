      ...
      m_normalState(new QState(m_sndState))
{
	...
	m_pulseOutState->assignProperty(thumb, "haloSize", 35 * 3);
	m_pulseInState->assignProperty(thumb, "haloSize", 28 * 3);

	m_inactiveState->assignProperty(thumb, "diameter", 11 * 3);
	m_focusState->assignProperty(thumb, "diameter", 11 * 3);
	m_slidingState->assignProperty(thumb, "diameter", 17 * 3);
