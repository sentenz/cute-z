...
# DI NodeID
echo "Generate nodeid header $CS_NODESET NodeID by generate_nodeid_header.py\n"
$PYTHON $PATH_TOOLS/generate_nodeid_header.py $PATH_UA_NODESET/$CS_NODESET/umati.csv $PATH_SRC_GENERATED/umati_nodeids $CS_NODESET
...
# Generate Datatype NS1
echo "Generate datatypes $CS_NODESET NS1 by generate_datatypes.py\n"
$PYTHON $PATH_TOOLS/generate_datatypes.py --namespace=2 --type-bsd=$PATH_UA_NODESET/$CS_NODESET/umati.bsd --type-csv=$PATH_UA_NODESET/$CS_NODESET/umati.csv --no-builtin $PATH_SRC_GENERATED/types_umati
...
# Compile NS1 umati
echo "\nNodeset_compiler $CS_NODESET NS1 by nodeset_compiler.py\n"
$PYTHON $PATH_TOOLS/nodeset_compiler/nodeset_compiler.py --internal-headers --types-array=UA_TYPES --types-array=UA_TYPES_UMATI --existing=$PATH_UA_NODESET/Schema/Opc.Ua.NodeSet2.xml --xml=$PATH_UA_NODESET/$CS_NODESET/umati.xml $PATH_SRC_GENERATED/namespace_umati_generated
...
# 
echo "\n\nBuild Server\n"
$SRC_GENERATED/../tools/build_umati
