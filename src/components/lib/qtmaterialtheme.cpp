...
{
    setColor("primary1", Material::grey900);
    ...
    setColor("canvasLight", Material::white);
    setColor("canvasDark", Material::black);
...
void QtMaterialTheme::setColor(const QString &key, Material::Color color)
{
    ...
    static const QColor palette[] = {
        ...
        QColor("#424242"), QColor("#282828"), QColor("#000000"), QColor("#ffffff"),
        d->rgba(0, 0, 0, 0),
        d->rgba(0, 0, 0, 1),
        d->rgba(0, 0, 0, 0.87),
        d->rgba(0, 0, 0, 0.54),
