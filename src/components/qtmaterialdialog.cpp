...
void QtMaterialDialog::setBackgroundColor(const QColor &color)
{
...
void QtMaterialDialog::setForegroundColor(const QColor &color)
{
    Q_D(QtMaterialDialog);

    d->dialogWindow->setForegroundColor(color);
}
...
void QtMaterialDialog::paintEvent(QPaintEvent *event)
{
    ...
    brush.setColor(this->m_colorBase);
