...
void QtMaterialTabs::addTab(const QIcon &icon, const QSize &size)
{
    addTab("", icon, size);
}

void QtMaterialTabs::addTab(const QString &text, const QIcon &icon, const QSize &size)
{
    Q_D(QtMaterialTabs);
...
void QtMaterialTabs::setTabText(const int index, const QString &text)
{
    Q_D(QtMaterialTabs);
